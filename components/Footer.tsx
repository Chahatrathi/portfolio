  ...
  return (
    <footer className="w-full pt-20 pb-10 relative overflow-hidden" id="contact">
      <div className="flex flex-col items-center relative z-10">
        ...
        {/* Check this line specifically - removed cite: 34 */}
        <p className="text-white-200 md:mt-10 my-5 text-center">
          Reach out to me today and let&apos;s discuss how I can contribute to 
          achieve your goals.
        </p>

        <a href="mailto:chahatrathi@gmail.com">
          <div className="flex items-center gap-2">
            {/* Removed the "" text that was likely here */}
            <MagicButton
      ...
      <div className="flex mt-16 md:flex-row flex-col justify-between items-center relative z-10">
        {/* Removed cite: 6, 46 from the copyright line */}
        <p className="md:text-base text-sm md:font-normal font-light">
          Copyright © 2026 Chahat Rathi
        </p>
